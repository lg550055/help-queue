...
import formVisibleReducer from '../../reducers/from-visible-reducer';
import ticketListReducer from '../../reducers/ticket-list-reducer';
import fromVisibleReducer from '../../reducers/from-visible-reducer';
...
describe("rootReducer", ()=>{
  ...
  test('Check that TOGGLE_FORM action works for formVisibleReducer and root reducer', ()=>{
    ...
    store.dispatch(action);
    expect(store.getState().formVisibleOnPage).toEqual(fromVisibleReducer(undefined, action));
  });
});